...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-bg flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background orbs */}
      <div className="orb w-96 h-96 bg-accent top-0 right-0 translate-x-1/2 -translate-y-1/2" />
      <div className="orb w-72 h-72 bg-purple-600 bottom-0 left-0 -translate-x-1/2 translate-y-1/2" />
      <div className="orb w-48 h-48 bg-blue-600 top-1/2 left-1/4" />
      ...
      <div className="w-full max-w-sm relative z-10 animate-fade-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">Sign in to continue your prep</p>
        </div>
        ...
        <div className="glass-strong rounded-2xl p-6 gradient-border">
          ...
          <p className="text-center text-xs text-white/25 mt-5">
            No account?{" "}
            <Link to="/register" className="text-accent-light hover:text-accent transition-colors">Create one</Link>
          </p>
        </div>
      </div>
    </div>
